...
from handlers.kupit_form import kupit_command
from handlers.kupit_form import Form2
from handlers.kupit_form import cancel_handler2
from handlers.kupit_form import process_done
from handlers.kupit_form import (
    form_start2,
    name_process2,
